...
Publish as:
``` BASH
mvn deploy  -P jfrog-deploy -DskipTests -DaltDeploymentRepository=jfrog-secfotech::default::https://secfotech.jfrog.io/artifactory/sophon-power-custom-3rd-party-local/
```